...
const History: () => React$Node = ({navigation}) => {
  return (
    <View style={{ flex: 1, backgroundColor: "#ecf0f1" }}>
      ...
      <View style={styles.containers}>
        <View style={styles.cards}>
          <TouchableOpacity style={{ alignItems: 'center' }} onPress = {()=> navigation.navigate('MyQueue')}>
            <Text style={{ paddingBottom: 25, }}>My Queue</Text>
          </TouchableOpacity>
        </View>
      </View>
